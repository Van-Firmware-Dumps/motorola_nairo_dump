...
cat product/app/MotCamera2AI/MotCamera2AI.apk.* 2>/dev/null >> product/app/MotCamera2AI/MotCamera2AI.apk
rm -f product/app/MotCamera2AI/MotCamera2AI.apk.* 2>/dev/null
...
cat product/priv-app/MotCamera2/MotCamera2.apk.* 2>/dev/null >> product/priv-app/MotCamera2/MotCamera2.apk
rm -f product/priv-app/MotCamera2/MotCamera2.apk.* 2>/dev/null
